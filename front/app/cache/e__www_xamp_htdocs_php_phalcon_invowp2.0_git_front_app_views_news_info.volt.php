...
<section class="banner">
    <div class="circle"><div class="circle-m"><span class=""></span><span class="cir-act"></span><span></span></div></div><ul>
      <li style="display: none;"><a href="http://www.hbedup.com/" target="_blank"><img src="<?php echo $this->url->get('hbjy/img/Img_QLhOMbUCxJ20130823103741.jpg'); ?>" width="100%"></a></li>
<li><a href="http://www.hbedup.com/library_show.php?id=1591" target="_blank"><img src="<?php echo $this->url->get('hbjy/img/Img_x8JaZckDT820131219153851.jpg'); ?>" width="100%"></a></li>
<li style="display: none;"><a href="http://www.hbedup.com/index.php#" target="_blank"><img src="<?php echo $this->url->get('hbjy/img/Img_Nflxd0Lkyb20130823103807.jpg'); ?>" width="100%"></a></li>
    </ul>
    <div class="arc"></div>
</section>
