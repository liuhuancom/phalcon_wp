...
{{ assets.outputJs('category_edit') }}
{{ assets.outputCss('category_edit') }}
                          ...
                          <td class="aligncenter"><span class="center">
                            ...
                            <td>{{ taga.WpTerms.name }}
                                <div class="row-actions">
                                 ...
                                 <span class="edit">
                                    {{ link_to("category/edit/"~taga.term_id~"?action=edit", "编辑") }} | </span>


                                    <span class="trash"><a class="submitdelete" title="删除" href="{{ url('category/edit/'~taga.term_id~'?action=delete') }}">删除</a> | </span>
