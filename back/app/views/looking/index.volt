                ...
                <div class="row-fluid">
                	<div class="span8">
                    	<ul class="widgeticons row-fluid">
                        	<li class="one_fifth"><a href=""><img src="{{url('')}}img/gemicon/location.png" alt="" /><span>Maps</span></a></li>
                            <li class="one_fifth"><a href=""><img src="{{url('')}}img/gemicon/image.png" alt="" /><span>Media</span></a></li>
                            <li class="one_fifth"><a href=""><img src="{{url('')}}img/gemicon/reports.png" alt="" /><span>Reports</span></a></li>
                            <li class="one_fifth"><a href=""><img src="{{url('')}}img/gemicon/edit.png" alt="" /><span>New Article</span></a></li>
                            <li class="one_fifth last"><a href=""><img src="{{url('')}}img/gemicon/mail.png" alt="" /><span>Check Mail</span></a></li>
                        	<li class="one_fifth"><a href=""><img src="{{url('')}}img/gemicon/calendar.png" alt="" /><span>Events</span></a></li>
                            <li class="one_fifth"><a href=""><img src="{{url('')}}img/gemicon/users.png" alt="" /><span>Manage Users</span></a></li>
                            <li class="one_fifth"><a href=""><img src="{{url('')}}img/gemicon/settings.png" alt="" /><span>Settings</span></a></li>
                            <li class="one_fifth"><a href=""><img src="{{url('')}}img/gemicon/archive.png" alt="" /><span>Archives</span></a></li>
                            <li class="one_fifth last"><a href=""><img src="{{url('')}}img/gemicon/notify.png" alt="" /><span>Notifications</span></a></li>
                        </ul>
